...
# Stratified Test/validation split by histological subtype an censored status

library(caret)

train.ind <- createDataPartition(
  cbind(as.vector(as.character(exp.info.ord[4,])), as.vector(as.character(ends.data.ord$PFI.1))),
